...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if($status == "Ended"){
        if($bookingdata['StudentID'] == NULL)
        {
            ...
            window.location.href="viewbooking_upcoming?bookingid=' . $bookingId . '";
            </script>';
            exit();
        }
    ...
    <div class="content">
        ...
        <form method="post">
            ...
            <div class="containerprofile">
                <input class="linktobutton" type="button" value="Cancel Update" onclick="location.href = 'viewbooking_upcoming?bookingid=<?php echo $bookingId; ?>'">
